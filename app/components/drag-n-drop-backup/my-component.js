...
var divSource = {
  beginDrag: function (props) {
    ...
    var dragItem={indexRow:props.indexRow,indexDiv:props.indexDiv};
    props.onBeginDragItem(dragItem);
    return {
        indexRow: props.indexRow,
        indexDiv: props.indexDiv,
  ...
  endDrag(props, monitor) {
      ...
      if (dropResult) {
        props.swapDiv({indexRow:item.indexRow,indexDiv:item.indexDiv}, {indexRow:dropResult.indexRow,indexDiv:dropResult.indexDiv});
      }
    }
};
...
var divTarget = {
  canDrop: function (props, monitor) {
      var item = monitor.getItem();
      var dropResult = monitor.getDropResult();
      if(item.indexRow == props.indexRow && item.indexDiv == props.indexDiv ){
        return false;
      }
...
var MyComponent = React.createClass({
  ...
  render: function () {
    ...
    return connectDragSource(connectDropTarget(
      ...
      <div className={this.props.className} index={this.props.indexRow+"."+this.props.div} style={{
        opacity: isDragging ? 0.3 : 1,
        transform:isDragging ? 'scale(0.7,0.7)' : 'scale(1,1)',
